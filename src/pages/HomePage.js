  ...
  return (
    <Box sx={{ bgcolor: "#f9f9f9", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          <strong>Donate Hope - For our compatriots</strong> là ứng dụng web phi
          lợi nhuận được thiết kế để hỗ trợ việc quyên góp từ thiện cho các nạn
          nhân bị ảnh hưởng bởi thiên tai, với mục tiêu đảm bảo tính công khai,
          minh bạch và hiệu quả trong quản lý quyên góp và phân phối tài trợ.
          <Box sx={{ mt: 2 }}>
            {[
