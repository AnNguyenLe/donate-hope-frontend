                ...
                <Link to="/campaign/create">
                    <Box
                        sx={{
                            ...
                            padding: "10px 20px",
                            borderRadius: "4px",
                            backgroundColor: isCharityAppUser
                                ? "primary.main"
                                : "grey.400",
                            color: isCharityAppUser
                                ? "white"
                                : "rgba(255, 255, 255, 0.5)",
                            textAlign: "center",
                            cursor: isCharityAppUser
                                ? "pointer"
                                : "not-allowed",
                            fontWeight: "bold",
                            fontSize: "16px",
                            boxShadow: isCharityAppUser ? 2 : 0,
                            "&:hover": isCharityAppUser && {
                                backgroundColor: "primary.dark",
                                boxShadow: 6,
                            },
                            "&:active": isCharityAppUser && {
                                backgroundColor: "primary.light",
                            },
                        }}
                        disabled={!isCharityAppUser}
                    >
