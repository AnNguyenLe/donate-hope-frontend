...
export default function CampaignDetail({ campaign, proofUrls }) {
  ...
  return (
    ...
    >
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography variant="h6">
                  Mục tiêu quyên góp: {campaign.goalAmount.toLocaleString()}{" "}
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography variant="h6" color="textSecondary">
                  Đã quyên góp được: {campaign.achievedAmount.toLocaleString()}{" "}
                  {campaign.unitOfMeasurement || "0"} | Status:{" "}
                  <Box
                    component="span"
                    sx={{
                      color:
                        campaign.goalStatus === "Completed"
                          ? "success.main"
                          : campaign.goalStatus === "InProgress"
                          ? "info.main"
                          : "text.disabled",
                    }}
                  >
        ...
        <Grid2 item xs={12} sm={6}>
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Typography variant="body2" color="textSecondary" marginRight={2}>
                <strong>Số lượt đánh giá:</strong> {campaign.numberOfRatings}
              </Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <StarIcon sx={{ marginRight: 1, color: "warning.main" }} />
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <MonetizationOnIcon sx={{ marginRight: 1, color: green[500] }} />
          <Typography
            variant="h5"
            fontWeight="bold"
        ...
        <Box marginTop={3}>
          ...
          >
            ...
            <a
              ...
              onMouseOver={(e) => (e.currentTarget.style.color = green[900])}
              onMouseOut={(e) => (e.currentTarget.style.color = green[700])}
            >
              Click here
            </a>
          </Typography>
